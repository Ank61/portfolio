...
export default function Blogs() {
    return (
        <main className="flex items-center justify-between w-full flex-col p-8 min-h-screen">
            <Common />
            <div className="grid grid-cols-2 gap-6 mb-auto mt-5">
                <div className=" max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg cursor-pointer transition-shadow">
                    <div className="p-5">
                        <a href="#">
